...
const Banner = () => {
    return (
        <div className=" ">
            <Carousel className="plo">
                <div className="relative h-full">
                    <img className="w-full h-full object-cover" src={b1} alt="Banner 1" />
                    <div className="absolute inset-0 bg-black bg-opacity-50 flex flex-col justify-center items-center ">
                        <div className="mb-80">
                        <h1 className="text-4xl font-bold text-gradient mb-10 ">Welcome to Hostel
                            Blaze</h1>
                ...
                <div className="relative h-full">
                    <img className="w-full h-full object-cover" src={b2} alt="Banner 1" />
                    <div className="absolute inset-0 bg-black bg-opacity-50 flex flex-col justify-center items-center ">
                        <div className="mb-80">
                        <h1 className="text-4xl font-bold text-gradient mb-10 ">Welcome to Hostel
                            Blaze</h1>
                ...
                <div className="relative h-full">
                    <img className="w-full h-full object-cover" src={b3} alt="Banner 1" />
                    <div className="absolute inset-0 bg-black bg-opacity-50 flex flex-col justify-center items-center ">
                        <div className="mb-80">
                        <h1 className="text-4xl font-bold text-gradient mb-10 ">Welcome to Hostel
                            Blaze</h1>
                ...
                <div className="relative h-full">
                    <img className="w-full h-full object-cover" src={b4} alt="Banner 1" />
                    <div className="absolute inset-0 bg-black bg-opacity-50 flex flex-col justify-center items-center ">
                        <div className="mb-80">
                        <h1 className="text-4xl font-bold text-gradient mb-10 ">Welcome to Hostel
                            Blaze</h1>
                ...
                <div className="relative h-full">
                    <img className="w-full h-full object-cover" src={b5} alt="Banner 1" />
                    <div className="absolute inset-0 bg-black bg-opacity-50 flex flex-col justify-center items-center ">
                        <div className="mb-80">
                        <h1 className="text-4xl font-bold text-gradient mb-10 ">Welcome to Hostel
                            Blaze</h1>
