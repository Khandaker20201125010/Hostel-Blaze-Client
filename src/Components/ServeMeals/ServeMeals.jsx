...
const ServeMeals = () => {
    ...
    useEffect(() => {
        const fetchRequestedMeals = async () => {
            try {
                const response = await axios.get('https://hostel-blaze-server.vercel.app/requested-meals');
    ...
    const serveMeal = async (id) => {
        try {
            await axios.patch(`https://hostel-blaze-server.vercel.app/requested-meals/${id}/deliver`);
            const response = await axios.get('https://hostel-blaze-server.vercel.app/requested-meals');
            setRequestedMeals(response.data);
        } catch (error) {
