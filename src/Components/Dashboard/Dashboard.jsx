  ...
  return (
    <div className="flex">
      <div className="ml-20 w-64 min-h-screen bg-gradient-to-r from-violet-950 to-blue-900 ">
        {isAdmin ? (
          <>
            <h1 className="text-center text-2xl text-white font-bold mt-5">
              Admin Home
            </h1>
            <ul className="text-white font-semibold">
              <li className="flex p-4 gap-2">
                <CgProfile className="text-2xl" />
                <NavLink to="/uDashboard/adminProfile">Admin Profile</NavLink>
              </li>
              <li className="flex p-4 gap-2">
                <MdManageAccounts className="text-2xl" />
                <NavLink to="/uDashboard/manageUsers">Manage Users</NavLink>
              </li>
              <li className="flex p-4 gap-2">
                <IoIosAddCircle className="text-2xl" />
                <NavLink to="/uDashboard/addMeals">Add Meals</NavLink>
              </li>
              <li className="flex p-4 gap-2">
              ...
              <li className="flex p-4 gap-2">
                <MdNoMealsOuline className="text-2xl" />
                <NavLink to="/uDashboard/addUpcomingMeals">
                  Upcoming Meals
                </NavLink>
              </li>
            </ul>
          ...
          <>
            ...
            <ul className="text-white font-semibold">
              <li className="flex p-4 gap-2">
                <CgProfile className="text-2xl" />
                <NavLink to="/uDashboard/myProfile">My Profile</NavLink>
              </li>
              <li className="flex p-4 gap-2">
                <MdNoMealsOuline className="text-2xl" />
                <NavLink to="/uDashboard/requestedMeals">
                  Requested Meals
                </NavLink>
              </li>
              <li className="flex p-4 gap-2">
                <MdRateReview className="text-2xl" />
                <NavLink to="/uDashboard/myReviews">My Reviews</NavLink>
              </li>
              <li className="flex p-4 gap-2">
                <MdPayment className="text-2xl" />
                <NavLink to="/uDashboard/paymentHistory">
                  Payment History
                </NavLink>
              </li>
            </ul>
