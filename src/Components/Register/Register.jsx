        ...
        <div className="min-h-screen lk p-2">
            ...
            <div className="w-4/5 lg:w-1/3 md:w-2/3 bg-gradient-to-r from-violet-950 to-blue-900 mx-auto mt-36 shadow-xl p-5 rounded-lg my-20">
                ...
                <form onSubmit={handleRegister}>
                    ...
                    <input className="w-full px-4 py-2 text-center text-lg rounded-md bg-gradient-to-r from-blue-950 to-violet-900 hover:bg-violet-800 border hover:border-red-500 text-white font-bold my-3" type="submit" value="Register" />
                </form>
