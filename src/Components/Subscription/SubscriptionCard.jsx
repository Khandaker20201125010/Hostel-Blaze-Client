...
const SubscriptionCard = ({item}) => {
    ...
    return (
      <div className="shadow-lg shadow-sky-800 flex flex-col group animate__animated animate__bounceIn h-full">
        <h3 className={' text-2xl text-yellow-600 bg-gradient-to-r from-red-700 to-black 0 font-bold text-center p-2 '}>{badge}</h3>
        <div className="p-10 flex flex-col flex-grow bg-gradient-to-r from-red-600 to-black hover:bg-blue-800">
          ...
          <div className="flex justify-center mt-auto">
            <Link to={`/uDashboard/payment/${_id}`}>
              <button className={`bg-white border-r-4 border-b-4 border-red-600 hover:bg-black px-4 py-2 rounded-md my-3 text-red-500 font-bold`}>
                Subscribe
              </button>
            </Link>
          </div>
